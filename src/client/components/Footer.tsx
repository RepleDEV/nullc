    ...
    render(): React.ReactNode {
        return (
            <div className="footer">
                <LinkIcon to="#"><GithubMark></GithubMark></LinkIcon>
                <LinkIcon to="#"><DiscordLogo /></LinkIcon>
                <LinkIcon to="#"><img src="https://storage.googleapis.com/pr-newsroom-wp/1/2021/02/Spotify_Icon_RGB_White.png" alt="Spotify Icon" /></LinkIcon>
            </div>
        );
    }
}