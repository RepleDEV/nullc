...
export default class Popup extends Component<PopupProps, {
    ...
    componentDidUpdate() {
        if (!this.container_ref || !this.popup_ref || Object.keys(this.state.popup_style).length)
            return;
    ...
    render(): React.ReactNode {
        ...
        return (
            <>
                ...
                }} className="click-container" onClick={this.toggleVisible}>
                    { children }
                </div>
            </>
        );
